...
class Hero(db.Model):
    ...
    comics_appeared_in = db.Column(db.String(150), nullable = True)
    ...
    def __repr__(self):
        return f"The following Hero has been created: {self.name}."
...
drone_schema = HeroSchema()
drones_schema = HeroSchema(many=True)